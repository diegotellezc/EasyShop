    ...
    return (
        <article className='border-[1px] border-gray-300 rounded-md'>
            ...
            overflow-hidden group'>
                ...
                <Link to={`/products/${product.id}`} className='absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 bg-happy-yellow hover:bg-happy-yellow-hover text-header-color font-medium text-lg grid place-items-center rounded-full max-w-max py-3 px-6 opacity-0 group-hover:opacity-100 transition-all duration-500 z-10 hover:scale-110'>
                            See details
                </Link>
            </div>
